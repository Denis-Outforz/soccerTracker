...
import './FootballEventController.css';
...
const FootballEventController = ({ onEventSelected }) => {
    ...
    const events = [
      ...
      { name: 'Attack Pass', subEvents: [
        { name: 'Key', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Cross', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Smart', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Through', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Final third', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Deep Cross', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Pass into penalty area', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
      ] },
      { name: 'Regular Pass', subEvents: [
        { name: 'Pass', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Head', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Short/medium pass', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Hand', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Deep', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Long', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Progressive', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Fair play', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
        { name: 'Throw in', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
      ] },
      { name: 'Reception', subEvents: [
        { name:'Under pressure', subSubEvents: ['Succesfull Reception', 'Missed Reception'] },
        { name:'Open play', subSubEvents: ['Succesfull Reception', 'Missed Reception'] },
      ]},
      { name: 'Shot', subEvents: [
        { name:'Left Foot Shot', subSubEvents: ['On Target', 'Off Target', 'Blocked'] },
        { name:'Right Foot Shot', subSubEvents: ['On Target', 'Off Target', 'Blocked'] },
        { name:'Head Shot', subSubEvents: ['On Target', 'Off Target', 'Blocked'] },
      ]},
      { name: 'Gk Action', subEvents: [
      ...
      { name: 'Free kick', subEvents: [
        { name: 'Curved', subSubEvents: ['On Target','Off Target','Blocked on the Wall'] },
        { name: 'Driven / Power', subSubEvents: ['On Target','Off Target','Blocked on the Wall'] },
        { name: 'Dipping', subSubEvents: ['On Target','Off Target','Blocked on the Wall'] },
        { name: 'Knuckleball', subSubEvents: ['On Target','Off Target','Blocked on the Wall'] },
        { name: 'Cross', subSubEvents: ['Successful', 'Failed Trajectory', 'Blocked'] },
      ]},
      { name: 'Penalty kick', subEvents: [
        { name:'Left Foot Shot', subSubEvents: ['On Target', 'Off Target'] },
        { name:'Right Foot Shot', subSubEvents: ['On Target', 'Off Target'] },
      ]},
      { name: 'Fouls', subEvents: [
            ...
            {events
              ...
              .subEvents.map((subEvent) => (
                <div key={subEvent.name}>
                  <button
                    className={`sub-event-button ${selectedSubEvent === subEvent.name ? 'selected' : ''}`}
                  ...
                  {selectedSubEvent === subEvent.name && (
                    <div className="sub-sub-event-buttons">
                      {subEvent.subSubEvents.map((subSubEvent) => (
                        <button
                          key={subSubEvent}
                          className={`sub-sub-event-button ${selectedSubSubEvent === subSubEvent ? 'selected' : ''}`}
