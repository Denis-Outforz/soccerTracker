...
const VideoPlayer = () => {
  ...
  const [homePlayers, setHomePlayers] = useState([
    21, 18, 7, 13, 23, 15, 2, 40, 35, 17, 31, 19, 25, 9, 24,
  ])
  const [awayPlayers, setAwayPlayers] = useState([
    1, 2, 5, 22, 20, 8, 31, 19, 18, 27, 11, 9, 10, 29, 23, 15,
  ])
  ...
  return (
    <div className="video-player-container">
      ...
      {isPlayerReady && (
        <>
          <div
            className={`football-field ${isFieldVisible && !isCtrlPressed ? 'show' : ''}`}
          ...
          >
            <div className="football-pitch">
              ...
              <div id="hover-marker1" className="hover-marker"></div>
              <div id="hover-marker2" className="hover-marker"></div>
              {point && (
          ...
          <div
            className={`football-field-secondary ${isFieldVisible && !isCtrlPressed ? 'show' : ''}`}
          >
